  ...
  <el-container>
    <el-header height='80px'>
      <div class="header">
        ...
        <!--不注释el-dropdown就会报错：Cannot read property 'disabled' of null-->
        <!--<el-dropdown>-->

        <div class="nav-right " v-if='userInfo.access_token'
             @mouseenter='enterHandler' @mouseleave='leaveHandler'>
    ...
    data() {
      return {
        headerList: [
          ...
          {id: '2', name: 'FreeCourse', title: '免费课程'},
          {id: '3', name: 'LightCourse', title: '轻课'},
          {id: '4', name: 'Course', title: '学位课程'},
          // {id: '5', name: 'Micro', title: '题库'}
        ],
